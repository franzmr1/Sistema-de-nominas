        ...
        public void ActualizarContrato(ContratoLaborales contrato)
        {
            ...
            using (SqlConnection con = conexion.ObtenerConexion())
            {
                ...
                if (contrato.FechaFin.HasValue)
                    ...
                    cmd.Parameters.AddWithValue("@Deducciones", contrato.Deducciones ?? 0.0M);  
                    cmd.Parameters.AddWithValue("@Bonificaciones", contrato.Bonificaciones ?? 0.0M);  
                    cmd.Parameters.AddWithValue("@HorasExtras", contrato.HorasExtras ?? 0.0M); 


                    cmd.Parameters.AddWithValue("@BonosCalculados", contrato.BonosCalculados ?? 0.0M);  
                    cmd.Parameters.AddWithValue("@DeduccionesCalculadas", contrato.DeduccionesCalculadas ?? 0.0M);  
                    cmd.Parameters.AddWithValue("@HorasExtrasCalculadas", contrato.HorasExtrasCalculadas ?? 0.0M);  
